...
const features = [
  {
    ...
    description: "Keep property-level rental income, platform fees, expenses and notes together.",
    icon: TableProperties
  },
  {
    title: "Receipt review workflow",
    description: "Upload receipts, extract draft fields with AI, then review before saving.",
    icon: ReceiptText
  },
  {
    ...
    <>
      <section className="bg-secondary/60">
        <div className="mx-auto grid min-h-[calc(100vh-8rem)] max-w-6xl content-center gap-10 px-4 py-14 md:grid-cols-[1.08fr_0.92fr] md:py-20">
          <div className="flex flex-col justify-center">
            <p className="mb-4 text-sm font-medium text-primary">For small short-term rental hosts</p>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-muted-foreground">
              Track rental income, add expenses, review AI receipt scans, document allocation assumptions and generate preparation reports.
            </p>
          ...
          <div className="rounded-lg border bg-background p-4 shadow-sm">
            <div className="grid gap-3">
              {["Rental income", "Candidate reportable expenses", "Receipts needing review"].map(
                (label, index) => (
      ...
      <section className="border-y bg-muted/40">
        <div className="mx-auto max-w-6xl px-4 py-10">
          ...
          <p className="mt-3 max-w-4xl text-sm leading-6 text-muted-foreground">{DISCLAIMER_TEXT}</p>
        </div>
      </section>
    </>
  );
